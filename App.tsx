          ...
          <div className="p-4 bg-slate-950 border-t border-slate-800">
            <div className="max-w-4xl mx-auto relative">
              <textarea
                ...
                placeholder={files.length === 0 ? "Adicione arquivos para começar..." : "Pergunte sobre os indicadores, peça comparações ou gráficos..."}
                  ...
                  {!pendingFile ? (
                    ...
                    <div className="animate-in fade-in zoom-in duration-300">
                      ...
                      <div className="space-y-5">
                        ...
                        <div>
                          <label className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider">Descrição do Arquivo</label>
                          <input 
                            type="text" 
                        ...
                        <div>
                          <label className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider">Fonte dos Dados</label>
                          <input 
                            type="text" 
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            <label className="block text-xs font-semibold text-amber-400 mb-1.5 uppercase tracking-wider">Nome do Indicador</label>
                            <input 
                              type="text" 
              ...
              <div className="space-y-4">
                ...
                {files.length === 0 ? (
                  ...
                  <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                    {files.map(file => (
                      <div key={file.id} className="bg-slate-900 border border-slate-800 rounded-xl p-4 hover:border-slate-700 transition-all group shadow-sm hover:shadow-md">
